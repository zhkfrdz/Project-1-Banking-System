...
public class Main {
     ...
     * @param menuIdx Main.Menu index to be shown
     * @param inlineTexts Number of menu options in a single line. Set to 1
     *                    if you only want a single menu option every line.
     * @see Menu
     */
    ...
    /**
     * Prompt some input to the user. Only receives on non-space containing
     * String. This string can then be parsed into targeted data type using DataTypeWrapper.parse() method.
     ...
     *                    <br>
     *                    Set to <b>true</b> if receiving only one String input without spaces.
     *                    <br>
     ...
     * @throws NumberFormatException May happen if the user attempts to input something other than numbers.
     */
